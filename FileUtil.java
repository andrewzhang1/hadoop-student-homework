...
public class FileUtil {
	static {System.out.println("FileUtil: modified by Michael Hsing 8/24/2014");}
    ...
    if (!dir.isDirectory()) {
      ...
      if(allFiles != null) {
        for (int i = 0; i < allFiles.length; i++) {
          ...
          isSymLink = false;   //Modified by Michael Hsing   8/24/1024    
/*          
          try {
...
//Modified by Michael Hsing 8/24/2014	  
	/*	  
    if (!rv) {
